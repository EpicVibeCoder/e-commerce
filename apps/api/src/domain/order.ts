...
> = new Map([
  [
    OrderStatus.pending,
    new Set([OrderStatus.confirmed, OrderStatus.cancelled]),
  ],
  [
    OrderStatus.confirmed,
    new Set([OrderStatus.processing, OrderStatus.cancelled]),
  ],
  [
    OrderStatus.processing,
    new Set([OrderStatus.shipped, OrderStatus.cancelled]),
  ],
