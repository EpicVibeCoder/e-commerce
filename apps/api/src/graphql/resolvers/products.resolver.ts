...
export class ProductsResolver {
      ...
      products(@Args("filter", { nullable: true }) filter?: ProductFilterInput, @Args("pagination", { nullable: true }) pagination?: PaginationInput) {
      ...
      @Query(() => [ProductModel])
      recommendations(@Args("productId", { type: () => ID }) productId: string, @Args("limit", { type: () => Int, defaultValue: 8 }) limit: number) {
